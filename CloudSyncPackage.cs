...
namespace CloudSync
{
    ...
    [InstalledProductRegistration("#110", "#112", "1.0", LanguageIndependentName="CloudSync", IconResourceID = 400)] // Info on this package for Help/About
    [ProvideMenuResource("Menus.ctmenu", 1)]
    //[ProvideToolWindow(typeof(DeployWindow))]
    [Guid(CloudSyncIDs.PackageGuidString)]
    [SuppressMessage("StyleCop.CSharp.DocumentationRules", "SA1650:ElementDocumentationMustBeSpelledCorrectly", Justification = "pkgdef, VS and vsixmanifest are valid VS terms")]
    public sealed class CloudSyncPackage : AsyncPackage
    {
        /// <summary>
        /// cmdCommandWindowPackage GUID string.
        /// </summary>
       // public const string PackageGuidString = "2cdac2c7-3110-48ec-8d71-f028f5c612ac";
        protected static string vsAppFolder = string.Empty;
        /// <summary>
        /// Initializes a new instance of the <see cref="CloudSyncPackage"/> class.
        /// </summary>
        public CloudSyncPackage()
        {
...
//            await cmdDeployWindow.InitializeAsync(this);
        ...
        public static void WriteToOutputWindow(string Message, string szCaption = "CloudSync", string szPaneGuid = VSConstants.OutputWindowPaneGuid.GeneralPane_string, bool bClear = false)
        {
        ...
        {
            WriteToOutputWindow(message, "CloudSync", null, true);
        }
