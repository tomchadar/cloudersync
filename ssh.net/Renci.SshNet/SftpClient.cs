...
namespace Renci.SshNet
{
    ...
    public class SftpClient : BaseClient
    {
        ...
        /// </remarks>
        public void UploadFile(Stream input, string path, Action<ulong,ulong> uploadCallback = null)
        {
        ...
        /// Method calls made by this method to <paramref name="input" />, may under certain conditions result in exceptions thrown by the stream.
        /// </remarks>
        public void UploadFile(Stream input, string path, bool canOverride, Action<ulong,ulong> uploadCallback = null)
        {
            CheckDisposed();
...
#region Upload the difference
        ...
        /// <exception cref="ArgumentException"><paramref name="path" /> is <b>null</b> or contains whitespace.</exception>
        /// <exception cref="SshConnectionException">Client not connected.</exception>
        private void InternalUploadFile(Stream input, string path, Flags flags, SftpUploadAsyncResult asyncResult, Action<ulong,ulong> uploadCallback)
        {
            if (input == null)
                throw new ArgumentNullException("input");
