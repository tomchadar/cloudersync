...
namespace CloudSync.SFTPClient
{
    public class SFTPSyncClient : SftpClient
    {
        ...
        {
            pane = CloudSyncPackage.GetWindowPane(Guid.Empty, "CloudSync", true, true);
        }
...
//                string dir = GetRemoteDirectoryName(path);
        ...
        {
            //CloudSyncPackage.WriteToOutputWindow(message, "CloudSync", null, true);
        ...
        public void LogProgress(string message)
        {
            ...
            //CloudSyncPackage.WriteToOutputWindow(message, "CloudSync", null, false);
        }
