...
namespace ClouderSync.SFTPClient
{
    public class SFTPSyncClient : SftpClient
    {
        ...
        /// </remarks>
        public new bool UploadFile(Stream input, string path, CancellationToken cancelToken, bool canOverride=true, Action<ulong,ulong> uploadCallback = null)
        {
            try
            {
                base.UploadFile(input,path, canOverride, cancelToken, uploadCallback);
            }
