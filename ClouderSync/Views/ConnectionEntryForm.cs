...
namespace ClouderSync.Views
{
    public partial class ConnectionEntryForm : Form
    {
        ...
        protected void BindControls()
        {
            ...
            checkCompressFilesFirst.DataBindings.Add(new Binding("Checked", connectEntry.ce, "compressbeforetransfer", true, System.Windows.Forms.DataSourceUpdateMode.OnPropertyChanged));
            return;
        }
