...
namespace ClouderSync
{
    public static class ClouderSyncIDs
    {
        ...
        public const string stringCommandWndCmdSet = "d10c84e7-2237-4b60-85eb-e0e1864f929f";
        ...
        public const string stringCompressCmdSet = "d10c84e7-2237-4b60-85eb-e0e1864f92a0";
        ...
        public static readonly Guid guidCommandWndCmdSet = new Guid(stringCommandWndCmdSet);
        ...
        public static readonly Guid guidCompressCmdSet = new Guid(stringCompressCmdSet);
        ...
        public const int cmdidCompress = 0x0103;
        public const int cmdidDeploy0 = 0x0110;
        public const int cmdidDeployWindow = 0x0105;
        public const int cmdWindowCmdGroup = 0x1022;
    }
}
